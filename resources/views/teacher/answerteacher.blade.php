...
@section('content')
        ...
        @foreach ($answers as $answer)
            <tbody>
                <tr>
                    ...
                    <td>{{ $answer->image }}</td>
                    <td>
                        <a href="{{ route('give-mark', ['id' => $answer->id]) }}" class="btn btn-success">Give Mark</a>
                    </td>
                </tr>
        @endforeach
        </tbody>
    ...
    <table class="table">
        <thead>
            ...
            <th>Teacher's Given-Mark</th>
            <th>Teacher's Given-Description</th>
        </thead>
        @if (!empty($marks))
            @foreach ($marks as $mark)
                <tbody>
                    <tr>
                        ...
                        <td>{{ $mark->user->subject->subjectfullname ?? 'unknown' }}({{ $mark->user->subject->subjectshortname ?? 'unknown' }})
                        </td>
